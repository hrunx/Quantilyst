...
export default function DashboardPage() {
  ...
  const [isSuggesting, setIsSuggesting] = useState(false); // ****** Re-added this state ******
  ...
  useEffect(() => {
    ...
    if (weeklyKeywords && weeklyKeywords.some(keyword => keyword.change > 15)) {
      ...
      <header className="sticky top-0 z-50 bg-primary text-primary-foreground p-4 shadow-lg">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Market Insights Pro</h1>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="shadow-xl rounded-xl overflow-hidden">
              <CardHeader className="bg-primary/5 dark:bg-primary/10">
                <CardTitle className="flex items-center gap-2 text-xl"><Search className="h-6 w-6 text-primary" /> Configure Your Analysis</CardTitle>
                <CardDescription>Tailor insights to your specific business needs and target market for optimal relevance.</CardDescription>
              </CardHeader>
            ...
            <Card className="shadow-xl rounded-xl overflow-hidden">
              <CardHeader className="bg-primary/5 dark:bg-primary/10">
                ...
                <CardDescription>Unlock deeper strategic insights for any specific keyword relevant to your business.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-6">
                <div>
            ...
            <Card className="shadow-xl rounded-xl overflow-hidden">
              <CardHeader className="bg-primary/5 dark:bg-primary/10">
                ...
                <CardDescription>Translate your trending keywords into Arabic, tailored for the KSA market.</CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4 min-h-[250px] pt-6">
                ...
                {!isSuggesting && seoSuggestions.length === 0 && (
                  <p className="text-sm text-muted-foreground text-center py-10">
                    Click the button below to generate AI-powered SEO content ideas.
                  </p>
                )}
              </CardContent>
              <CardFooter className="bg-muted/50 dark:bg-muted/20 p-4">
